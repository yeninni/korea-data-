...
export default function FilterBar({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-[1.75rem] bg-white p-4 shadow-sm ring-1 ring-slate-200 lg:flex-row lg:items-center lg:justify-between">
      <div className="flex items-center gap-3 font-display text-sm font-semibold text-slate-600">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <select
          ...
          className="focus-ring min-h-12 rounded-2xl border border-slate-200 bg-white px-4 font-display font-semibold text-slate-700"
        >
        ...
        <label className="focus-within:ring-civic-500 flex min-h-12 items-center gap-3 rounded-2xl border border-slate-200 px-4 font-display font-semibold text-slate-700 focus-within:ring-2">
          <input
            type="checkbox"
            checked={largeOnly}
